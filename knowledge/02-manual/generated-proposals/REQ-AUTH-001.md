...
id: manual-REQ-AUTH-001
title: Manual verification for REQ-AUTH-001
status: stable
trust_status: grounded
review_status: reviewed
requirement: ../../01-product/requirements/auth.md
sources:
  - resource: /knowledge/01-product/requirements/auth.md
---

# Manual verification for REQ-AUTH-001
...
See [approved product requirement](../../01-product/requirements/auth.md).
